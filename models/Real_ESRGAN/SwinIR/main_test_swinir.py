...
from models.Real_ESRGAN.SwinIR.models.network_swinir import SwinIR as net
from models.Real_ESRGAN.SwinIR.utils import util_calculate_psnr_ssim as util
...
def main():
    ...
    parser.add_argument('--model_path', type=str,
                        default='models/Real_ESRGAN/experiments/pretrained_models/003_realSR_BSRGAN_DFO_s64w8_SwinIR-M_x4_GAN.pth')
    parser.add_argument('--folder_lq', type=str, default="models/Real_ESRGAN/BSRGAN/testsets/RealSRSet", help='input low-quality test image folder')
    parser.add_argument('--folder_gt', type=str, default=None, help='input ground-truth test image folder')
    parser.add_argument('--tile', type=int, default=800, help='Tile size, None for no tile during testing (testing as a whole)')
...
def setup(args):
    ...
    # 003 real-world image sr
        ...
        print("task is real_sr")
        save_dir = f'models/Real_ESRGAN/results/swinir_{args.task}_x{args.scale}'
        if args.large_model:
            save_dir += '_large'
